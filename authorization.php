...
if (!isset($_COOKIE['auto'])) {
    echo '
<form action="authorizationController.php" method="POST" enctype="multipart/form-data">
...
';
    ...
    $email = $_COOKIE['email'];
    echo '<form action="authorizationController.php" method="POST" enctype="multipart/form-data">
    <input type="email" class="form-control" name="email" id="email" placeholder="Введите email"
